...
class OnboardingScreen extends StatelessWidget {
  ...
  final List<Map<String, String>> _onboardingData = [
    {"image": "assets/icons/Onboarding1.svg", "description": "به اپلیکیشن تبدیل ویس به متن خوش آمدید"},
    {"image": "assets/icons/Onboarding2.svg", "description": "ویس بده متنش رو تحویل بگیر"},
    {"image": "assets/icons/Onboarding3.svg", "description": "جزوه‌ها رو بر اساس موضوع دسته‌بندی کن"},
  ];
